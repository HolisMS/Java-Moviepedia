...
import static satella.app.movies4.utilities.Utils.ARG_TVSHOW_FAV_STATE;
...
public class FavoriteTvShowFragment extends Fragment {
    ...
    @BindView(R.id.rv_fav_tvshow)
    RecyclerView mRecyclerView;

    @BindView(R.id.progressFavtvShow)
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getActivity()).setTitle(getString(R.string.favorite_tvshow));
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putParcelableArrayList(ARG_TVSHOW_FAV_STATE, mAdapter.getmList());
    }
